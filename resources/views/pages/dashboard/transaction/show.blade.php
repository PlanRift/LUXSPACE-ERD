<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h2 class="font-semibold text-lg text-grey-800 leading-tight mb-5">Transaction Detail</h2>
                ...
                <div class="text-dark p-6 border-b border-gray-200">
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Paymet Url</th>
            ...
            <h2 class="font-semibold text-lg text-grey-800 leading-tight mb-5">Transaction Items</h2>
